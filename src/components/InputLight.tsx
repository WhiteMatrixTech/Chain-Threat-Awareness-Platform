 ...
 * @LastEditTime: 2024-09-11 15:33:06
 */
...
export function InputLight(props: IProps) {
    ...
    <div className={cn(`${pattern.flexCenter}`, className)}>
      ...
      >
        ...
        <input
          ...
          className="w-full h-full bg-transparent text-[16px] text-[#000000] border-0 outline-none"
        />
      </div>
    </div>
  );
